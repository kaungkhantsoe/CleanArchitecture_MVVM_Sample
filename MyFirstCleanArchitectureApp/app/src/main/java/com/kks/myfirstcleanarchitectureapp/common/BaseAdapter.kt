...
abstract class BaseAdapter @JvmOverloads constructor(items: List<Pageable>? = null) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    private inner class ProgressHolder internal constructor(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    private inner class RetryHolder internal constructor(itemView: View, @IdRes retryTriggerViewId: Int) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
